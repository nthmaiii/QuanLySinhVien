 ...
 * @author HP
 */
public class KhoaHocIoT implements Serializable {
    ...
    public String toString() {
        return "KhoaHocIoT{" + "ma_hoc_vien=" + ma_hoc_vien + ", ho_ten=" + ho_ten + ", ngay_sinh=" + ngay_sinh + ", gioi_tinh=" + gioi_tinh + ", tinh_trang=" + tinh_trang + ", diem=" + diem + ", ngay_bat_dau=" + ngay_bat_dau + ", ngay_ket_thuc=" + ngay_ket_thuc + ", khoa=" + khoa + '}';
    }
