...
public class HocVienDAOImpl implements HocVienDAO {
    ...
    public List<HocVien> getList() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                hocVien.setMa_nguoi_tao_hv(rs.getInt("ma_nguoi_tao_hv"));
                list.add(hocVien);
            }
            ps.close();
            cons.close();
    ...
    public int createOrUpdate(HocVien hocVien) {
            ...
            if (!isValidMaNguoiTaoTk((int)hocVien.getMa_nguoi_tao_hv())) {
                JOptionPane.showMessageDialog(null, "Mã người tạo tài khoản không hợp lệ: " + hocVien.getMa_nguoi_tao_hv(),
            ...
            try (Connection cons = DBConnect.getConnection();
                ...
                ps.setInt(8, hocVien.getMa_nguoi_tao_hv());
                ps.execute();
